# ============================================================
# WorkforceX - Worker App (KMP Version): Build & Run
...
Write-Host "  WorkforceX Worker App (KMP) - Build & Run  " -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($sdkFound -eq "") {
    ...
    Write-Host "  .\run-worker-kmp.ps1 -SdkPath 'C:\Your\Sdk\Path'" -ForegroundColor Yellow
    exit 1
}
